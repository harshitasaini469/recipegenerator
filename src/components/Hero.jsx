...
const Hero = () => {
  return <div>
    <section class="bg-white dark:bg-gray-900" style={{backgroundImage: "url(./images/bg5.jpg)"}}>
    ...
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <p class="max-w-2xl mb-6  lg:mb-8 md:text-lg lg:text-xl text-white">From checkout to global sales tax compliance, companies around the world use Flowbite to simplify their payment stack.</p>
