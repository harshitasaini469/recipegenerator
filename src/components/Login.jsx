...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12 relative">
      <Link to="/">
        <div className="bg-green-700 w-fit rounded-full px-2 py-1 text-center absolute top-0 mt-3 ml-3">
          <p className="text-4xl font-bold text-white">&#8592;</p>
        </div>
      </Link>
      <div className="relative py-3 sm:max-w-xl sm:mx-auto">
        <div className="absolute inset-0 bg-gradient-to-r from-green-600 to-green-700 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl"></div>
